<template>
  ...
  <div class="d-flex flex-column px-3 h-75">
    <textarea name="" id="" placeholder="¿Qué hay que contar?"></textarea>
  <FabButton icon="fa-save"/>

  <img src="https://cdn2.cocinadelirante.com/sites/default/files/styles/gallerie/public/perritos_0.jpg"
    alt="entry-picture"
    class="img-thumbnail">
  </div>
